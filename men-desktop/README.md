...
1. **Clonar el repositorio:**
   ```bash
   git clone https://github.com/TU_USUARIO/Proyecto-Grupo5-Esquina-Noroeste.git
...
Una vez finalizado el proceso, el instalador autoejecutable se encontrará dentro de la carpeta `dist-electron/` (el nombre y ruta exacta puede depender del sistema operativo en el que se construya).
